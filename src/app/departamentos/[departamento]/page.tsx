      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {department.members.map((member, index) => (
            ...
            >
              <div className={`relative h-full ${bgGradient} rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2`}>
                {/* Decorative elements */}
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex justify-center gap-3 pt-6 border-t border-gray-200">
                    <Link
                      ...
                      className="flex items-center justify-center w-10 h-10 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full transition-all duration-200 hover:scale-110"
                    ...
                    <Link
                      ...
                      onClick={(e) => e.stopPropagation()}
                      className="flex items-center justify-center w-10 h-10 bg-green-100 hover:bg-green-200 text-green-600 rounded-full transition-all duration-200 hover:scale-110"
                    ...
                    {member.social.linkedin && (
                      <Link
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="flex items-center justify-center w-10 h-10 bg-indigo-100 hover:bg-indigo-200 text-indigo-600 rounded-full transition-all duration-200 hover:scale-110"
                        title="LinkedIn"
                      >
